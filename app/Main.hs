...
main = do
    ...
    list1M <- uniformListRM 1000000 (-999, 999) gen
    defaultMain
        [ bgroup
            "maxProd"
        ...
        , bgroup
            "maxProdFast"
            [ bench "len=10,m=4" $ whnf (maxProdFast list10) 4
            , bench "len=100,m=4" $ whnf (maxProdFast list100) 4
            , bench "len=1k,m=4" $ whnf (maxProdFast list1k) 4
            , bench "len=1M,m=4" $ whnf (maxProdFast list1M) 4
            ]
        ]
